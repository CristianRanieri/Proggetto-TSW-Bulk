  ...
  <div id="blocco-seleziona-caratteristiche">
    <form action="pageProdotti">
      ...
      <div id="blocco-prezzo">
        <input type="range" id="prezzo" onchange="stapaPrezzo()" name="price" min="0" max="99" value="<%= request.getAttribute("prezzo")%>"> <span id="stampa-prezzo"> </span>
      </div>
      ...
      <%-- hidden data per categoria e specifica --%>
      <input type="hidden" name="category" value="<%= request.getParameter("category")%>">
      <input type="hidden" name="specific" value="<%= request.getParameter("specific")%>">
    </form>
  </div>
